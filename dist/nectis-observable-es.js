...
var Theme = { colours, getChartJSStyle, getChartPanelStyle, getColour, getNarrativeStyle, getStyle, getTableStyle };
...
const buildTabbedTile = (tile, visuals) => {
    ...
    for (const visual of visuals) {
        tabsElement.appendChild(buildTab());
    }
